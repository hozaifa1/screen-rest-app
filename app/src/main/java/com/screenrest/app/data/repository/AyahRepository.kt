...
import com.screenrest.app.data.remote.QuranApiService
import com.screenrest.app.data.remote.dto.toAyah
...
interface AyahRepository {
    ...
    suspend fun getAyahByReference(surah: Int, ayah: Int): Result<Ayah>
}
...
class AyahRepositoryImpl @Inject constructor(
    ...
    private fun getMaxAyahsForSurah(surah: Int): Int {
        return when (surah) {
